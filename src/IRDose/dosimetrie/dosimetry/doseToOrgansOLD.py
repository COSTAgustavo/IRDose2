...
# --------------------------------------- Sigma K I D N E Y S ------------------------------------------
kidneys_sigmaDoseBM = np.sqrt((uncDoseBM[b_kidneys].sum()**2).sum())/b_kidneys.sum()
kidneys_sigmaDoseG = np.sqrt((uncDoseG[b_kidneys].sum()**2).sum())/b_kidneys.sum()
kidneys_sigmaDoseX = np.sqrt((uncDoseX[b_kidneys].sum()**2).sum())/b_kidneys.sum()
kidneys_sigmaDoseIE = np.sqrt((uncDoseIE[b_kidneys].sum()**2).sum())/b_kidneys.sum()
kidneys_sigmaDoseAE = np.sqrt((uncDoseAE[b_kidneys].sum()**2).sum())/b_kidneys.sum()
...
# ----------------------- Sigma S P L E E N -----------------------------
spleen_sigmaDoseBM = np.sqrt((uncDoseBM[b_spleen].sum()**2).sum())/b_spleen.sum()
spleen_sigmaDoseG = np.sqrt((uncDoseG[b_spleen].sum()**2).sum())/b_spleen.sum()
spleen_sigmaDoseX = np.sqrt((uncDoseX[b_spleen].sum()**2).sum())/b_spleen.sum()
spleen_sigmaDoseIE = np.sqrt((uncDoseIE[b_spleen].sum()**2).sum())/b_spleen.sum()
spleen_sigmaDoseAE = np.sqrt((uncDoseAE[b_spleen].sum()**2).sum())/b_spleen.sum()
