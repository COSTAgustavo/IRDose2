		...
		Gate -a [testNumber,mkdjvkjsdv_IE][particule,e-][tissue,mkdjvkjsdv][nPrimaries,0.1548][emissionType,IE][resolution_x,512][resolution_y,512][resolution_z,76][sourceShift_x,249.999872][sourceShift_y,249.999872][sourceShift_z,190.0][pixel_x,0.976562][pixel_y,0.976562][pixel_z,5] mainMacro.mac > ../output/mkdjvkjsdv/run_IE.log ;
		#Gate -a [testNumber,mkdjvkjsdv_IE][particule,e-][tissue,mkdjvkjsdv][nPrimaries,0.1548][emissionType,IE][patientCT,mkdjvkjsdv] mainMacro.mac > ../output/mkdjvkjsdv/run_IE.log ;
