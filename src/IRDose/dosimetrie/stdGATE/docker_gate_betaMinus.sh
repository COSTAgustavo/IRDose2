		...
		Gate -a [testNumber,mkdjvkjsdv_betaMinus][particule,e-][tissue,mkdjvkjsdv][nPrimaries,1][emissionType,betaMinus][resolution_x,512][resolution_y,512][resolution_z,76][sourceShift_x,249.999872][sourceShift_y,249.999872][sourceShift_z,190.0][pixel_x,0.976562][pixel_y,0.976562][pixel_z,5] mainMacro.mac > ../output/mkdjvkjsdv/run_betaMinus.log ;
		#Gate -a [testNumber,mkdjvkjsdv_betaMinus][particule,e-][tissue,mkdjvkjsdv][nPrimaries,1][emissionType,betaMinus][patientCT,mkdjvkjsdv] mainMacro.mac > ../output/mkdjvkjsdv/run_betaMinus.log ;
