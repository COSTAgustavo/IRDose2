...
print('Dose Source = ', round(doseArrayT[b_source].sum()/b_source.sum()*cumActivity,2), '+-', round(sigmaSource*cumActivity,2) , '(',round((sigmaSource*cumActivity)/(doseArrayT[b_source].sum()/b_source.sum()*cumActivity)*100,2),'%)', file=outFile)
print('Dose Source = ', round(doseArrayT[b_source].sum()/b_source.sum()*cumActivity,2), '+-', round(sigmaSource*cumActivity,2) , '(',round((sigmaSource*cumActivity)/(doseArrayT[b_source].sum()/b_source.sum()*cumActivity)*100,2),'%)')

if target_1=='True':
    print('Dose Target_1 = ', round(doseArrayT[b_target_1].sum()/b_target_1.sum()*cumActivity,2) ,'+-', round(sigmaTarget_1*cumActivity,2), '(', round(sigmaTarget_1/(doseArrayT[b_target_1].sum()/b_target_1.sum())*100,2), '%)', file=outFile)
    print('Dose Target_1 = ', round(doseArrayT[b_target_1].sum()/b_target_1.sum()*cumActivity,2) ,'+-', round(sigmaTarget_1*cumActivity,2), '(', round(sigmaTarget_1/(doseArrayT[b_target_1].sum()/b_target_1.sum())*100,2), '%)')
if target_2=='True':
    print('Dose target_2 = ', round(doseArrayT[b_target_2].sum()/b_target_2.sum()*cumActivity,2) ,'+-', round(sigmaTarget_2*cumActivity,2), '(', round(sigmaTarget_2/(doseArrayT[b_target_2].sum()/b_target_2.sum())*100,2), '%)', file=outFile)
    print('Dose target_2 = ', round(doseArrayT[b_target_2].sum()/b_target_2.sum()*cumActivity,2) ,'+-', round(sigmaTarget_2*cumActivity,2), '(', round(sigmaTarget_2/(doseArrayT[b_target_2].sum()/b_target_2.sum())*100,2), '%)')
